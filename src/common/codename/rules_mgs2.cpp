...
constexpr GridRow kGridTanker[] = {
    ...
    {"Tarantula", 16, 49, 0, 10, 1, 15},
    {"Centipede", 11, -1, 11, -1, 1, 15},
    {"Spider", 16, 49, 11, -1, 1, 15},
    {"Jaguar", 6, 15, 0, 10, 1, 15},
    {"Panther", 16, 49, 0, 10, 1, 15},
    {"Leopard", 11, -1, 11, -1, 1, 15},
    {"Puma", 16, 49, 11, -1, 1, 15},
    {"Jackal", 16, 30, 0, 10, 1, 15},
    {"Tasmanian Devil", 16, 49, 0, 10, 1, 15},
    {"Mongoose", 11, -1, 11, -1, 1, 15},
    {"Hyena", 16, 49, 11, -1, 1, 15},
    {"Iguana", 31, 49, 0, 10, 1, 15},
    {"Crocodile", 16, 49, 0, 10, 1, 15},
    {"Comodo Dragon", 11, -1, 11, -1, 1, 15},
    {"Alligator", 16, 49, 11, -1, 1, 15},
};
constexpr GridRow kGridPlant[] = {
    {"Scorpion", 1, 15, 0, 30, 1, 60},
    {"Tarantula", 61, 199, 0, 30, 1, 60},
    {"Centipede", 31, -1, 31, -1, 1, 60},
    {"Spider", 61, 199, 31, -1, 1, 60},
    {"Jaguar", 16, 40, 0, 30, 1, 60},
    {"Panther", 61, 199, 0, 30, 1, 60},
    {"Leopard", 31, -1, 31, -1, 1, 60},
    {"Puma", 61, 199, 31, -1, 1, 60},
    {"Jackal", 41, 70, 0, 30, 1, 60},
    {"Tasmanian Devil", 61, 199, 0, 30, 1, 60},
    {"Mongoose", 31, -1, 31, -1, 1, 60},
    {"Hyena", 61, 199, 31, -1, 1, 60},
    {"Iguana", 71, 199, 0, 30, 1, 60},
    {"Crocodile", 61, 199, 0, 30, 1, 60},
    {"Comodo Dragon", 31, -1, 31, -1, 1, 60},
    {"Alligator", 61, 199, 31, -1, 1, 60},
};
constexpr GridRow kGridTP[] = {
    {"Scorpion", 1, 20, 0, 40, 1, 70},
    {"Tarantula", 71, 249, 0, 40, 1, 70},
    {"Centipede", 41, -1, 41, -1, 1, 70},
    {"Spider", 71, 249, 41, -1, 1, 70},
    {"Jaguar", 21, 50, 0, 40, 1, 70},
    {"Panther", 71, 249, 0, 40, 1, 70},
    {"Leopard", 41, -1, 41, -1, 1, 70},
    {"Puma", 71, 249, 41, -1, 1, 70},
    {"Jackal", 51, 80, 0, 40, 1, 70},
    {"Tasmanian Devil", 71, 249, 0, 40, 1, 70},
    {"Mongoose", 41, -1, 41, -1, 1, 70},
    {"Hyena", 71, 249, 41, -1, 1, 70},
    {"Iguana", 81, 249, 0, 40, 1, 70},
    {"Crocodile", 71, 249, 0, 40, 1, 70},
    {"Comodo Dragon", 41, -1, 41, -1, 1, 70},
    {"Alligator", 71, 249, 41, -1, 1, 70},
};
