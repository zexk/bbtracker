...
void apply_game_theme()
{
    ...
    if (g_game == Game::MGSPW) {
        ...
        colors[ImGuiCol_FrameBgActive]     = ImVec4(0.86f, 0.06f, 0.09f, 1.00f);
        ...
        colors[ImGuiCol_CheckMark]         = ImVec4(0.94f, 0.94f, 0.92f, 1.00f);
        colors[ImGuiCol_SliderGrab]        = ImVec4(0.62f, 0.62f, 0.60f, 1.00f);
        colors[ImGuiCol_SliderGrabActive]  = ImVec4(0.86f, 0.06f, 0.09f, 1.00f);
        colors[ImGuiCol_Button]            = ImVec4(0.11f, 0.11f, 0.12f, 1.00f);
        colors[ImGuiCol_ButtonHovered]     = ImVec4(0.55f, 0.05f, 0.07f, 1.00f);
        colors[ImGuiCol_ButtonActive]      = ImVec4(0.86f, 0.06f, 0.09f, 1.00f);
        ...
        colors[ImGuiCol_HeaderActive]      = ImVec4(0.32f, 0.32f, 0.33f, 1.00f);
        colors[ImGuiCol_TableHeaderBg]     = ImVec4(0.16f, 0.16f, 0.17f, 1.00f);
        colors[ImGuiCol_Tab]               = ImVec4(0.10f, 0.10f, 0.11f, 1.00f);
        colors[ImGuiCol_TabHovered]        = ImVec4(0.55f, 0.05f, 0.07f, 1.00f);
        colors[ImGuiCol_TabActive]         = ImVec4(0.86f, 0.06f, 0.09f, 1.00f);
        colors[ImGuiCol_TabUnfocused]      = ImVec4(0.08f, 0.08f, 0.09f, 1.00f);
        colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.45f, 0.04f, 0.06f, 1.00f);
        colors[ImGuiCol_Separator]         = ImVec4(0.86f, 0.86f, 0.83f, 0.45f);
        colors[ImGuiCol_TableBorderStrong] = ImVec4(0.60f, 0.60f, 0.58f, 0.55f);
        colors[ImGuiCol_TableBorderLight]  = ImVec4(0.40f, 0.40f, 0.39f, 0.45f);
        colors[ImGuiCol_TableRowBgAlt]     = ImVec4(0.13f, 0.13f, 0.14f, 0.55f);
        colors[ImGuiCol_ResizeGrip]        = ImVec4(0.86f, 0.06f, 0.09f, 0.35f);
        colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.86f, 0.06f, 0.09f, 0.75f);
        colors[ImGuiCol_ResizeGripActive]  = ImVec4(0.95f, 0.10f, 0.12f, 1.00f);
...
int mgs3_area_kerotan(const char* code)
{
    static constexpr AreaName kAreas[] = {
        ...
        {"s044a", "21"}, {"s051a", "22"}, {"s051b", "22"}, {"s052a", "23"},
        {"s052b", "24"},
