...
on, so the panel projects the title, the takedown spread behind it, the grade
ladder, and insignia progress.
...
Press `F3` to toggle overlay. In MGS2, MGS3, MGS4, and Peace Walker, press `F4` to cycle tabs.
